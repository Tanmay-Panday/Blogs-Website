      ...
      {filteredBlogs.length > 0 ? (
        filteredBlogs.map(({ _id, title, email, image, content }) => (
          <div
            ...
            className="bg-white border rounded-lg overflow-hidden shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px] dark:bg-blue-gray-700 cursor-pointer hover:shadow-2xl hover:-translate-y-1.5"
          >
            <img
              src={image}
              alt={title}
            ...
            <div className="p-4">
              ...
              <h4 className="text-sm text-gray-500 mt-2 dark:text-blue-gray-300">
                By: {email}
              </h4>
            </div>
          </div>
