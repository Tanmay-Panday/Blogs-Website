    ...
    return (
      ...
      >
        ...
        <MenuList className="p-1">
          <Link to="/profile">
            <MenuItem className="flex items-center gap-2 dark:text-white dark:bg-darkmode-surface-tonal-a30">
          ...
          <MenuItem
            className="flex items-center gap-2 hover:bg-red-500/10 dark:bg-darkmode-surface-tonal-a30"
  ...
  return (
    <div className="flex items-center gap-x-1">
      <Button
        variant="text"
        size="sm"
        className="text-black bg-blue-gray-100 dark:text-white dark:bg-darkmode-surface-a10"
